...
@Component({
  ...
  template: `
    <footer class="border-t border-white/5 bg-black pt-16 pb-8" role="contentinfo">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">

          <!-- Brand -->
          <div class="md:col-span-2">
            <a href="#" class="flex items-center gap-2 mb-4" aria-label="Lumen Systems - Inicio">
              <div class="w-6 h-6 rounded bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xs" aria-hidden="true">
                L
              </div>
              <span class="font-bold text-lg text-white">Lumen Systems</span>
            </a>
            <p class="text-gray-500 text-sm max-w-sm mb-6">
              Tecnología clara. Soluciones reales.<br>
              Fundada por <strong class="text-gray-400">Alan Herrera</strong>.
            </p>
          ...
          <nav aria-label="Servicios">
            ...
            <ul class="space-y-2 text-sm text-gray-500">
              @for (link of serviceLinks; track link.label) {
                <li>
                  <a [href]="link.href" class="hover:text-purple-400 transition-colors">
                    {{ link.label }}
                  </a>
                </li>
              }
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-gray-600 text-sm">© {{ currentYear }} Lumen Systems. Todos los derechos reservados.</p>
